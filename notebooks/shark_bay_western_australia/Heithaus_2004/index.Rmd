---
title: Bundling Heithaus 2004 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Heithaus, Michael. (2004). Fish communities of subtropical seagrass meadows and associated habitats in Shark Bay, Western Australia. Bulletin of Marine Science. 75. 79-99. ](http://www.monkeymiadolphins.org/wp-content/uploads/2019/10/Heithaus-2004.pdf)
...
dataset_dir_name <- "Heithaus_2004"
original_pdf <- "Fish_communities_of_subtropical_seagrass_meadows_a.pdf"
short_name <- "shark-bay-heithaus-2004"
...
page_args <- c(
  "-a 76.806,40.329,646.554,160.033 -p 7"
)
...
processed_csv <- "Fish_communities_of_subtropical_seagrass_meadows_a_tables_parsed_1.csv"
...
#add unidentified family back in
cleaned_data[31,] = "Congridae"
...
combined_dataframe[3,2:3] = c("Carcharhinus amblyrhynchos", 217337)
combined_dataframe[8,2:3] = c("Chiloscyllium punctatum", 277833)
...
#Simplify shape because the WKT length is too long
...
#Title
title <- "Fish communities of subtropical seagrass meadows and associated habitats in Shark Bay, Western Australia: Fishes Checklist"
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Heithaus, Michael. (2004). Fish communities of subtropical seagrass meadows and associated habitats in Shark Bay, Western Australia. Bulletin of Marine Science. 75. 79-99. ")
    )
  )
)
  ...
  temporalCoverage = eml$temporalCoverage(
    rangeOfDates = eml$rangeOfDates(
      beginDate = eml$beginDate(
        calendarDate = "1997-06-01"
      ),
      endDate = eml$endDate(
        calendarDate = "1999-07-31"
      )
    )
   )
)
