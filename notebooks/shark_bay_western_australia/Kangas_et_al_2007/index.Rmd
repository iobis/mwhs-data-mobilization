---
title: Bundling Kangas et al. 2007 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Kangas, M. I., Morrison, S., Unsworth, P., Lai, E., Wright, I., and Thomson, A. (2007). Development of biodiversity and habitat monitoring systems for key trawl fisheries in Western Australia. Final FRDC Report 2002/038. Fisheries Research Report 160.](https://www.fish.wa.gov.au/Documents/research_reports/frr160.pdf)
...
dataset_dir_name <- "Kangas_et_al_2007"
original_pdf <- "frr160.pdf"
short_name <- "shark-bay-kangas-2007"
...
page_args <- c(
  "-a 213.927,172.258,771.999,273.455 -p 99",
  "-a 64.364,173.746,764.558,274.199 -p 100",
  "-a 62.876,173.746,763.069,274.199 -p 101",
  "-a 62.876,173.746,758.605,274.199 -p 102",
  "-a 64.364,173.746,775.719,273.455 -p 103",
  "-a 60.644,174.49,764.558,273.455 -p 104",
  "-a 61.388,174.49,505.613,271.967 -p 105"
)
...
processed_csv <- "frr160_tables_parsed_concatenated.csv"
...
combined_dataframe[3, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Mustelus", "sp. A", 105732)
combined_dataframe[17, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Himantura", "(toshi?)", 105752)
combined_dataframe[34, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Spratelloides", "robustus?", 125722)
combined_dataframe[76,2:3] = c("Kanekonia queenslandica", 281210)
combined_dataframe[195, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Amblyeleotris", "sp.?", 206516)
combined_dataframe[205, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Engyprosopon", "sp. 1?", 204480)
combined_dataframe[206,2:3] = c("Grammatobothus pennatus", 280935)
combined_dataframe[213,2:3] = c("Aseraggodes melanospilus", 313770)
...
#Title
title <- "Development of biodiversity and habitat monitoring systems for key trawl fisheries in Western Australia: Fishes Checklist"
...
creator <- list(eml$creator(
    individualName = eml$individualName(
      givenName = "M.I.", 
      surName = "Kangas"),
    organizationName = "Western Australian Fisheries and Marine Research Laboratories"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "S.", 
      surName = "Morrison"),
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Kangas, M. I., Morrison, S., Unsworth, P., Lai, E., Wright, I., and Thomson, A. (2007). Development of biodiversity and habitat monitoring systems for key trawl fisheries in Western Australia. Final FRDC Report 2002/038. Fisheries Research Report 160.")
    )
  )
)
