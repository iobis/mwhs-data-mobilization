...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Earl C., OBIS Secretariat. (2023) An overview of fishes of the Sundarbans, Bangladesh and their present conservation status: Fishes Checklist. [Version 1]. UNESCO. Occurrence Dataset DOI",
      bibliography = list(
