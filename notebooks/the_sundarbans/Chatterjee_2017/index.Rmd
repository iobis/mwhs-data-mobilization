...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Earl C., OBIS Secretariat. (2023) State Of The Art Report On Biodiversity In Indian Sundarbans: Fishes Checklist. [Version 1]. UNESCO. Occurrence Dataset DOI",
      bibliography = list(
