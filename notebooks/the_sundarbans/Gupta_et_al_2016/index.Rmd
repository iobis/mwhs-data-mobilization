---
title: Bundling Gupta et al. 2016 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Gupta, Sandipan & Dubey, Sourabh & Trivedi, Raman & Chand, Bimal & Banerjee, Samir. (2016). Indigenous ornamental freshwater ichthyofauna of the Sundarban Biosphere Reserve, India: Status and prospects. Journal of Threatened Taxa. 8. 9144.](https://doi.org/10.11609/jott.1888.8.9.9144-9154)
...
The data for this reference is formatted as an text-based table inside a PDF across multiple sheets. First, we use [pdf_to_table](https://github.com/sunray1/pdf_to_table) to parse out the table to a CSV.
...
# Generate taxonID:
occurrence %<>% mutate(occurrenceID = paste("indian-sundarbans-gupta-2016", "occurrence", vdigest (scientificName, algo="md5"), sep=":"))
```
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Earl C, Provost P (2023) Indigenous ornamental freshwater ichthyofauna of the Sundarban Biosphere Reserve, India: status and prospects: Fishes Checklist. [Version 1]. UNESCO. Occurrence Dataset DOI",
      bibliography = list(
        citation = "Gupta S, Dubey S, Trivedi R, Chand B, & Banerjee S. (2016). Indigenous ornamental freshwater ichthyofauna of the Sundarban Biosphere Reserve, India: Status and prospects. Journal of Threatened Taxa. 8. 9144. https://doi.org/10.11609/jott.1888.8.9.9144-9154")
    )
  )
)
```
...
methods <- eml$methods(
  methodStep = eml$methodStep(
    description = "See Github R Project and Notebook - https://github.com/iobis/mwhs-data-mobilization/tree/master/notebooks/the_sundarbans/Gupta_et_al_2016 - for dataset construction"
  )
)
