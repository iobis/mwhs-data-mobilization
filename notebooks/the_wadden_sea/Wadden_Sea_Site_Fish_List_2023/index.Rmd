---
title: Bundling Wadden Sea Site Species List 2023 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
Common Wadden Sea Secretariat: Wadden Sea Site Species List 2023
...
dataset_dir_name <- "Wadden_Sea_Site_Fish_List_2023"
original_pdf <- ""
short_name <- "wadden-sea-site-list-2023"

```

# Parsing PDF table to CSV

Don't have to do this since we have the CSV
...
processed_csv <- "Wadden_Sea_fish_species.csv"
...
combined_dataframe[17,2:3] = c("Barbus barbus", 154292)
combined_dataframe[25,2:3] = c("Carassius gibelio", 234033)
combined_dataframe[28,2:3] = c("Chelidonichthys cuculus", 127259)
combined_dataframe[29,2:3] = c("Chelidonichthys lastoviza", 127261)
combined_dataframe[34,2:3] = c("Chondrostoma nasus", 154585)
combined_dataframe[43,2:3] = c("Cottus perifretum", 1009257)
combined_dataframe[69,2:3] = c("Labrus bimaculatus", 126966)
combined_dataframe[90,2:3] = c("Micropogonias undulatus", 151158)
combined_dataframe[94,2:3] = c("Mullus surmuletus", 126986)
combined_dataframe[124,2:3] = c("Rhodeus amarus", 154331)

combined_dataframe <- combined_dataframe[-c(100, 157, 158, 159, 160),]
...
#Title
title <- "Common Wadden Sea Secretariat: Fishes Checklist"
...
abstract <- eml$abstract(
  para = "The species list for the Wadden Sea obtained from the Common Wadden Sea Secretariat."
)
```
...
creator <- eml$creator(
  individualName = eml$individualName(
    givenName = "Julia A.", 
    surName = "Busch"),
  organizationName = "Common Wadden Sea Secretariat"
)
