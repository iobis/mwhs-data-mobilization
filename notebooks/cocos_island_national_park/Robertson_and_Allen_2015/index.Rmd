...
[D R Robertson and Gerald R Allen. 2015. Shorefishes of the Tropical Eastern Pacific: online information system. Version 2.0 Smithsonian Tropical Research Institute, Balboa, Panamá. Cocos Island National Park.](https://biogeodb.stri.si.edu/sftep/en/pages)
...
original_pdf <- ""
short_name <- "cocos-robertson-allen-2015"
...
processed_csv <- "Local_Endemism.csv"
...
#Title
title <- "Shorefishes of the Tropical Eastern Pacific: online information system: Cocos Island: Fishes Checklist"
...
abstract <- eml$abstract(
  para = "Mobilized species checklist from the Shorefishes of the Tropical Easter Pacific, specifically the confirmed (species collected within the park boundaries) species list from Cocos Island National Park"
)
```
