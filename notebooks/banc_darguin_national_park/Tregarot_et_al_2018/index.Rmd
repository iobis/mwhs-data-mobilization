...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Earl C., OBIS Secretariat. (2023) Évaluation du Service de Nerserie du Parc National du Banc d’arguin, Mauritania: Fishes Checklist. [Version 1]. UNESCO. Occurrence Dataset DOI",
      bibliography = list(
