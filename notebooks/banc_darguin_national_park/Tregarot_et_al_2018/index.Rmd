...
short_name <- "banc-darguin-tregarot-2018"
...
combined_dataframe[20,2:3] = c("Pegusa triophthalma", 274308)

combined_dataframe[7, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Cynoglossus", "senegalensis", 126112)
combined_dataframe[14, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Epinephelus", "aeneus", 126068)
combined_dataframe[34, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Sparus", "qurata", 126082)
