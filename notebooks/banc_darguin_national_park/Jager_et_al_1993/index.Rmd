...
short_name <- "banc-darguin-jager-1993"
...
combined_dataframe[16,2:3] = c("Pseudotolithus brachygnathus", 304267)
combined_dataframe[28, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Malacoctenus", "sp. nov.?", 269781)
combined_dataframe[29, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Parablennius", "incognitus?", 125920)
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "This will be auto-filled in by the IPT",
      bibliography = list(
        citation = "Jager, Z. The distribution and abundance of young fish in the Banc d'Arguin, Mauritania. Hydrobiologia 258, 185–196 (1993).")
    )
  )
)

citationdoi <- "https://doi.org/10.1007/BF00006196"
```
