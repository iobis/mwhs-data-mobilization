...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Earl C., OBIS Secretariat. (2023) The distribution and abundance of young fish in the Banc d'Arguin, Mauritania: Fishes Checklist. [Version 1]. UNESCO. Occurrence Dataset DOI",
      bibliography = list(
