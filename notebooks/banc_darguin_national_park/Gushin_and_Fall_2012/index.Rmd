...
combined_dataframe[18,2:3] = c("Citharichthys stampflii", 275695)
combined_dataframe[69,2:3] = c("Smaris macrophthalmus", 321559)
combined_dataframe[72,2:3] = c("Sparisoma rubripinne", 159301)

#I think this species doesn't exist - typo
combined_dataframe[77,2:3] = c("Spicara spicara", NA)

combined_dataframe[84,2:3] = c("Tilapia guineensis", 367733)
