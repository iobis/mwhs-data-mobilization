...
short_name <- "banc-darguin-gushin-and-fall-2012"
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Gushchina A V, Fall K O M, Earl C (2023). Ichthyofauna of Littoral of the Gulf Arguin, Mauritania: Fishes Checklist. Version 1.0. OBIS Secretariat. Occurrence dataset. https://ipt.obis.org/secretariat/resource?r=banc-darguin-gushin-and-fall-2012&v=1.0",
      bibliography = list(
        citation = "Gushchin, A.V., Fall, K.O.M. Ichthyofauna of littoral of the gulf Arguin, Mauritania. J. Ichthyol. 52, 160–171 (2012).")
    )
  )
)

citationdoi <- "https://doi.org/10.1134/S0032945212010055"
...
methods <- eml$methods(
  methodStep = eml$methodStep(
    description = eml$description(
      para = "See Github <a href=\"https://github.com/iobis/mwhs-data-mobilization\">Project</a> and <a href=\"https://github.com/iobis/mwhs-data-mobilization/tree/master/notebooks/banc_darguin_national_park/Gushin_and_Fall_2012\"> R Notebook</a> for dataset construction methods"
    )
  )
)
