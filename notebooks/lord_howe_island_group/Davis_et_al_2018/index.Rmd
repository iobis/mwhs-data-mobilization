---
title: Bundling Davis et al. 2018 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Davis, Tom & Larkin, Meryl & Harasti, David. (2018). Application of non-destructive methods for assessing rock pool fish assemblages on Lord Howe Island, Australia. Regional Studies in Marine Science. 24.](https://doi.org/10.1016/j.rsma.2018.09.002)
...
dataset_dir_name <- "Davis_et_al_2018"
original_pdf <- ""
short_name <- "lord-howe-davis-2018"

```

# Parsing PDF table to CSV

The data for this reference is formatted as an image-based table inside a PDF across multiple sheets. First, we use [pdf_to_table](https://github.com/sunray1/pdf_to_table) to OCR and parse out the table to a CSV. Don' have to do this since we have the raw data in a CSV
...
processed_csv <- "1-s2.0-S2352485518302111-mmc1.csv"
...
#Title
title <- "Application of non-destructive methods for assessing rock pool fish assemblages on Lord Howe Island, Australia: Fishes Checklist"
...
creator <- list(eml$creator(
    individualName = eml$individualName(
      givenName = "Tom R.", 
      surName = "Davis"),
    organizationName = "NSW Department of Primary Industries"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Meryl F.", 
      surName = "Larkin"),
    organizationName = "Southern Cross University"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "David", 
      surName = "Harasti"),
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Davis, T & Larkin, M & Harasti, D. (2018). Application of non-destructive methods for assessing rock pool fish assemblages on Lord Howe Island, Australia. Regional Studies in Marine Science. 24.")
    )
  )
)

citationdoi <- "https://doi.org/10.1016/j.rsma.2018.09.002"
```
