---
title: Bundling Villela et al. 2003 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Villela, P.C. & Sale, Peter & Gold-Bouchot, Gerardo & Kjerfve, Björn. (2003). MESOAMERICAN BARRIER REEF SYSTEMS PROJECT: MANUAL OF METHODS FOR THE MBRS SYNOPTIC MONITORING PROGRAM. Selected Methods for Monitoring Physical and Biological Parameters for Use in the Mesoamerican Region.](https://rris.biopama.org/sites/default/files/2021-03/MBRS%20synoptic%20monitoring.pdf)
...
The data for this reference is formatted as an image-based table inside a PDF across multiple sheets. First, we use [pdf_to_table](https://github.com/sunray1/pdf_to_table) to OCR and parse out the table to a CSV. We don't have to do this since we have the raw data.
