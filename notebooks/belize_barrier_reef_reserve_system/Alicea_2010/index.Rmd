---
title: Bundling Alicea 2010 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Alicea, Eileen (2010). Laughing Bird Caye National Park management plan 2011 - 2016 : a component of Belize's world heritage site.](https://repository.library.noaa.gov/view/noaa/820)
...
dataset_dir_name <- "Alicea_2010"
original_pdf <- "noaa_820_DS1.pdf"
short_name <- "belize-barrier-reef-alicea-2010"
...
page_args <- c(
"-a 144.203,194.693,710.303,368.348 -p 241",
"-a 95.243,195.458,711.068,367.583 -p 242",
"-a 96.008,195.458,706.478,366.818 -p 243",
"-a 96.008,195.458,705.713,366.818 -p 244",
"-a 94.478,195.458,660.578,366.818 -p 245",
"-a 95.243,195.458,705.713,367.583 -p 246",
"-a 95.243,196.223,207.698,367.583 -p 247"
)
...
processed_csv <- "noaa_820_DS1_tables_parsed_concatenated.csv"
...
combined_dataframe[4,2:3] = c("Albula vulpes", 212256)
combined_dataframe[5,2:3] = c("Apogon binotatus", 272982)
combined_dataframe[10,2:3] = c("Astrapogon stellatus", 279774)
combined_dataframe[14,2:3] = c("Canthidermis sufflamen", 127399)
combined_dataframe[18,2:3] = c("Monacanthus tuckeri", 159499)
combined_dataframe[24,2:3] = c("Ablennes hians", 159246)
combined_dataframe[28,2:3] = c("Caranx bartholomaei", 302312)
combined_dataframe[51,2:3] = c("Emblemaria pandionis", 280653)
combined_dataframe[59,2:3] = c("Dasyatis guttata", 271434)
combined_dataframe[63,2:3] = c("Echeneis neucratoides", 159678)
combined_dataframe[70,2:3] = c("Ctenogobius saepepallens", 276488)
combined_dataframe[73,2:3] = c("Coryphopterus glaucofraenum", 159736)
combined_dataframe[75,2:3] = c("Gnatholepis thompsoni", 277493)
combined_dataframe[77,2:3] = c("Gobiosoma evelynae", 309568)
combined_dataframe[112,2:3] = c("Doratonotus megalepis", 280576)
combined_dataframe[122,2:3] = c("Xyrichtys splendens", 273608)
combined_dataframe[129,2:3] = c("Lutjanus mahogoni", 159799)
combined_dataframe[138,2:3] = c("Mulloidichthys martinicus", 277991)
combined_dataframe[168,2:3] = c("Stegastes adustus", 276659)
combined_dataframe[190,2:3] = c("Scomberomorus regalis", 273819)
combined_dataframe[194,2:3] = c("Cephalopholis cruentatus", 401279)
combined_dataframe[203,2:3] = c("Hypoplectrus gummigutta", 281115)
combined_dataframe[218,2:3] = c("Serranus tortugarum", 273910)
combined_dataframe[228,2:3] = c("Chilomycterus antennatus", 275239)
combined_dataframe[229,2:3] = c("Chilomycterus antillarum", 275240)

combined_dataframe <- combined_dataframe[-c(79, 80, 81),]
...
```{r locality}
locality <- "Belize Barrier Reef Reserve System"
...
#Title
title <- "Laughing Bird Caye National Park management plan 2011 - 2016: a component of Belize's world heritage site: Fishes Checklist"
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Alicea, Eileen (2010). Laughing Bird Caye National Park management plan 2011 - 2016 : a component of Belize's world heritage site.")
    )
  )
)
...
coverage <- eml$coverage(
  geographicCoverage = eml$geographicCoverage(
    geographicDescription = "Belize Barrier Reef Reserve System",
