---
title: Bundling Galvan et al. 2009 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Galván, David & Venerus, Leonardo & Irigoyen, Alejo. (2009). The Reef-fish Fauna of the Northern Patagonian Gulfs, Argentina, South-western Atlantic. The Open Fish Science Journal. 2. 90-98.](http://dx.doi.org/10.2174/1874401X00902010090)
...
dataset_dir_name <- "Galvan_et_al_2009"
original_pdf <- "The_Reef-fish_Fauna_of_the_Northern_Patagonian_Gul.pdf"
short_name <- "peninsula-valdes-galvan-2009"
...
page_args <- c(
  "-a 115.898,149.558,559.598,349.223 -p 4"
)
...
processed_csv <- "The_Reef-fish_Fauna_of_the_Northern_Patagonian_Gul_tables_parsed_concatenated.csv"
...
#Title
title <- "The Reef-fish Fauna of the Northern Patagonian Gulfs, Argentina, South-western Atlantic: Fishes Checklist"
...
creator <- list(eml$creator(
    individualName = eml$individualName(
      givenName = "David E.", 
      surName = "Galván"),
    organizationName = "Centro Nacional Patagónico (CONICET)"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Leonardo A.", 
      surName = "Venerus"),
    organizationName = "Centro Nacional Patagónico (CONICET)"
  ), eml$creator(
    individualName = eml$individualName(
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Galván, David & Venerus, Leonardo & Irigoyen, Alejo. (2009). The Reef-fish Fauna of the Northern Patagonian Gulfs, Argentina, South-western Atlantic. The Open Fish Science Journal. 2. 90-98.")
    )
  )
)

citationdoi <- "http://dx.doi.org/10.2174/1874401X00902010090"
```
