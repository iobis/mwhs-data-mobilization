...
[D R Robertson and Gerald R Allen. 2015. Shorefishes of the Tropical Eastern Pacific: online information system. Version 2.0 Smithsonian Tropical Research Institute, Balboa, Panamá. Archipiélago de Revillagigedo.](https://biogeodb.stri.si.edu/sftep/en/pages)
...
original_pdf <- ""
short_name <- "revillagigedo-robertson-allen-2015"
...
processed_csv <- "Taxonomic_Functional_Group-All_Species.csv"
...
combined_dataframe[160, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Pareques", "species A", 270286)
combined_dataframe[208, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Xyrichtys", "species B", 126025)
...
#Title
title <- "Shorefishes of the Tropical Eastern Pacific: online information system: Archipiélago de Revillagigedo: Fishes Checklist"
...
abstract <- eml$abstract(
  para = "Mobilized species checklist from the Shorefishes of the Tropical Easter Pacific, specifically the confirmed (species collected within the park boundaries) species list from Archipiélago de Revillagigedo"
)
```
...
citationdoi <- "https://biogeodb.stri.si.edu/sftep/en/pages"
```
