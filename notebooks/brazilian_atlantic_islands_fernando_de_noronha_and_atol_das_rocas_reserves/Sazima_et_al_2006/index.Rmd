---
title: Bundling Sazima et al. 2006 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Sazima, Ivan & Sazima, Cristina & Silva-Jr, José. (2006). Fishes associated with spinner dolphins at Fernando de Noronha Archipelago, tropical Western Atlantic: an update and overview. Neotropical Ichthyology - NEOTROP ICHTHYOL. 4.](https://doi.org/10.1590/S1679-62252006000400009)
...
dataset_dir_name <- "Sazima_et_al_2006"
original_pdf <- "b1fc35f8bed7ad2566b1765f94ba0a81239a.pdf"
short_name <- "noronha-sazima-2006"
...
page_args <- c(
  "-a 473.918,147.263,743.198,254.363 -p 2"
)
...
processed_csv <- "b1fc35f8bed7ad2566b1765f94ba0a81239a_tables_parsed_1.csv"
...
cleaned_data <- input_data %>%
  filter(str_count(fish_species, "\\S+") > 1)
...
#Title
title <- "Fishes associated with spinner dolphins at Fernando de Noronha Archipelago, tropical Western Atlantic: an update and overview: Fishes Checklist"
...
creator <- list(eml$creator(
    individualName = eml$individualName(
      givenName = "Ivan", 
      surName = "Sazima"),
    organizationName = "Departamento de Zoologia e Museu de História Natural"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Cristina", 
      surName = "Sazima"),
    ...
    individualName = eml$individualName(
      givenName = "José Martins", 
      surName = "da Silva-Jr"),
    organizationName = "Centro Golfinho Rotador"
  )
)
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Sazima, Ivan & Sazima, Cristina & Silva-Jr, José. (2006). Fishes associated with spinner dolphins at Fernando de Noronha Archipelago, tropical Western Atlantic: an update and overview. Neotropical Ichthyology - NEOTROP ICHTHYOL. 4.")
    )
  )
)

citationdoi <- "https://doi.org/10.1590/S1679-62252006000400009"
```
  ...
  temporalCoverage = eml$temporalCoverage(
    rangeOfDates = eml$rangeOfDates(
      beginDate = eml$beginDate(
        calendarDate = "1998-06-01"
      ),
      endDate = eml$endDate(
        calendarDate = "2006-10-31"
      )
    )
   )
)
