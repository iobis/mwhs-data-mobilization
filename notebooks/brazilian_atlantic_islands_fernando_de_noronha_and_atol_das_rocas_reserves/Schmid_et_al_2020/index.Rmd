---
title: Bundling Schmid et al. 2020 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
[Schmid, Kurt & Miranda, Fabio & Santos, Bárbara & Alves Bezerra, Natalia & Garla, Ricardo & Giarrizzo, Tommaso. (2020). First fish fauna assessment in the Fernando de Noronha Archipelago with BRUVS: Species catalog with underwater imagery. Biota Neotropica. 20.](https://doi.org/10.1590/1676-0611-BN-2020-1014)
...
dataset_dir_name <- "Schmid_et_al_2020"
original_pdf <- "1676-0611-bn-20-04-e20201014_published.pdf"
short_name <- "noronha-schmid-2020"
...
page_args <- c(
  "-a 213.053,50.108,740.138,275.018 -p 3",
  "-a 83.003,40.928,721.778,277.313 -p 4",
  "-a 86.828,49.343,357.638,246.713 -p 5"
)
...
processed_csv <- "1676-0611-bn-20-04-e20201014_published_tables_parsed_concatenated.csv"
...
combined_dataframe[46,2:3] = c("Stegastes rocasensis", 276683)
...
```{r locality}
locality <- "Brazilian Atlantic Islands: Fernando de Noronha and Atol das Rocas Reserves"
...
#Title
title <- "First fish fauna assessment in the Fernando de Noronha Archipelago with BRUVS: Species catalog with underwater imagery.: Fishes Checklist"
...
creator <- list(eml$creator(
    individualName = eml$individualName(
      givenName = "Kurt", 
      surName = "Schmid"),
    organizationName = "Universidade Federal do Pará, Núcleo de Ecologia Aquática e Pesca da Amazônia"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Fábio Renan Miranda", 
      surName = "da Silva"),
    organizationName = "Universidade Federal do Pará, Núcleo de Ecologia Aquática e Pesca da Amazônia"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Bárbara Janaína Vieira", 
      surName = "dos Santos"),
    organizationName = "Universidade Federal do Pará, Núcleo de Ecologia Aquática e Pesca da Amazônia"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Natalia Priscila Alves", 
      surName = "Bezerra"),
    organizationName = "Universidade Federal Rural de Pernambuco"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Ricardo Clapis", 
      surName = "Garla"),
    organizationName = "Universidade Federal do Rio Grande do Norte"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Tommaso", 
      surName = "Giarrizzo"),
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Schmid, Kurt & Miranda, Fabio & Santos, Bárbara & Alves Bezerra, Natalia & Garla, Ricardo & Giarrizzo, Tommaso. (2020). First fish fauna assessment in the Fernando de Noronha Archipelago with BRUVS: Species catalog with underwater imagery. Biota Neotropica. 20.")
    )
  )
)

citationdoi <- "https://doi.org/10.1590/1676-0611-BN-2020-1014"
```
