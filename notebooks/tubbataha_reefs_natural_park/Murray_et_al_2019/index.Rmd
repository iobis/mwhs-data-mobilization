---
title: Bundling Murray et al. 2019 to a DwC Archive
date: "`r Sys.Date()`"
author: Chandra Earl
output: (function(...) {
...
dataset_dir_name <- "Murray_et_al_2019"
original_pdf <- "1-s2.0-S2287884X18301596-main.pdf"
short_name <- "tubbataha-murray-2019"
...
page_args <- c(
  "-a 601.601,155.888,722.888,247.412 -p 4"
)
...
processed_csv <- "1-s2.0-S2287884X18301596-main_tables_parsed_1.csv"
...
#Title
title <- "Tubbataha Reefs Natural Park: the first comprehensive elasmobranch assessment reveals global hotspot for reef sharks: Fishes Checklist"
...
creator <- list(eml$creator(
    individualName = eml$individualName(
      givenName = "Ryan", 
      surName = "Murray"),
    organizationName = "Large Marine Vertebrates Research Institute Philippines"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Segundo", 
      surName = "Conales Jr."),
    organizationName = "Tubbataha Management Office"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Gonzalo", 
      surName = "Araujo"),
    ...
    individualName = eml$individualName(
      givenName = "Simon J.", 
      surName = "Pierce"),
    organizationName = "Marine Megafauna Foundation"
  ), eml$creator(
    individualName = eml$individualName(
      givenName = "Angelique", 
      surName = "Songco"),
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      bibliography = list(
        citation = "Murray, Ryan & Conales, Segundo & Araujo, Gonzalo & Labaja, Jessica & Snow, Sally & Pierce, Simon & Songco, Angelique & Ponzo, Alessandro. (2018). Tubbataha Reefs Natural Park: First comprehensive elasmobranch assessment reveals global hotspot for reef sharks. Journal of Asia-Pacific Biodiversity. 12.")
    )
  )
)

citationdoi <- "https://doi.org/10.1016/j.japb.2018.09.009"
```
