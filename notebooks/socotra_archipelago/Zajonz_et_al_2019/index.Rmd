...
combined_dataframe[328, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Chaetodon", "Chaetodon collare × Chaetodon lunula", 125954)
combined_dataframe[342, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Pomacanthus", "Pomacanthus asfur × Pomacanthus maculosus", 159286)
combined_dataframe[343, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Pomacanthus", "Pomacanthus semicirculatus × Pomacanthus maculosus", 159286)
combined_dataframe[357, c("CanonicalFull", "identificationQualifier", "WormsIDs")] <- c("Dascyllus", "Dascyllus carneus × Dascyllus marginatus", 205736)

#combination not in WoRMs
combined_dataframe[375,2:3] = c("Plectroglyphidodon leucozonus cingulum", NA)

combined_dataframe <- combined_dataframe[-c(26, 237),]
...
additionalMetadata <- eml$additionalMetadata(
  metadata = list(
    gbif = list(
      ...
      citation = "Earl C., OBIS Secretariat. (2023) Coastal fish diversity of the Socotra Archipelago, Yemen: Fishes Checklist. [Version 1]. UNESCO. Occurrence Dataset DOI",
      bibliography = list(
